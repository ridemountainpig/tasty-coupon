...
|**生鮮雜貨優惠碼** : ```滿$999享9折最高可折$150可用1次```|```春節家潔```|```~1/30```|```MiaC’bon```|
|**生鮮雜貨優惠碼** : ```滿$999享9折最高可折$150可用2次```|```家福舞新春```|```~2/6```|```家樂福家樂福超市```|
...
|**特選餐廳優惠** : ```暖暖燒仙草手熬冬瓜拿鐵 買一送一```|```無```|```~1/30```|```珍煮丹指定分店```|
|**特選餐廳優惠** : ```檸檬午茉綠 買一送一```|```無```|```~1/30```|```再睡五分鐘```|
|**特選餐廳優惠** : ```王的華堡餐 買一送一```|```無```|```~1/30```|```漢堡王指定分店```|
|**特選餐廳優惠** : ```雞脖子派對熱銷組 買一送一```|```無```|```~1/30```|```頂呱呱指定分店```|
|**特選餐廳優惠** : ```拿鐵咖啡雞柳條 買一送一```|```無```|```~1/30```|```創意麵指定分店```|
|**特選餐廳優惠** : ```滿$399 贈牛肉炸醬麵```|```無```|```~1/30```|```三商巧福指定分店```|
|**特選餐廳優惠** : ```滿$499贈日式唐揚雞```|```無```|```~1/30```|```福勝亭指定分店```|
|**特選餐廳優惠** : ```8塊上校雞塊 買一送一```|```無```|```~1/30```|```肯德基```|
|**特選餐廳優惠** : ```滿$299折$35```|```無```|```~1/30```|```肯德基甜點專賣店```|
|**特選餐廳優惠** : ```冬瓜檸檬文清檸檬烏梅紅茶青草紅茶 買一送一```|```無```|```~1/30```|```老賴茶棧指定分店```|
...
|**特選餐廳優惠** : ```甘蔗紅茶  買一送一```|```無```|```~2/13```|```好初早餐```|
|**特選餐廳優惠** : ```指定品項甜甜圈 買10送10```|```無```|```~1/30```|```MisterDonut```|
...
|**天選之人分眾優惠碼** : ```滿$299享75折最高折抵$100可用1次```|```一袋一袋享```|```~1/28```|```分眾```|
|**天選之人分眾優惠碼** : ```滿$219享75折最高折抵$100可用1次```|```一袋一袋享```|```~1/28```|```分眾```|
