...
|**UberEats分眾優惠碼** : ```滿 $299 享 85 折最高折抵 $150可用２次```|```幸運八五折X9P```|```~ 9/10```|```無```|
...
|**UberEats【生鮮雜貨】優惠碼** : ```滿 $888 折 $100可用１次```|```無```|```~ 9/10```|```屈臣氏```|
|**UberEats【特選餐廳】優惠** : ```滿 $399 折 $100```|```無```|```兌完為止```|```Mister Dount```|
|**UberEats【特選餐廳】優惠** : ```買 起司咔滋餅贈 芝心腸2個```|```無```|```贈完為止```|```必勝客```|
|**UberEats【特選餐廳】優惠** : ```小樹酪梨蔬菜佛陀碗皮蛋芝麻葉沙拉番茄蔬菜湯買 1 送 1```|```無```|```9/11~9/24```|```小小樹食```|
|**UberEats【特選餐廳】優惠** : ```雲霧烏龍(L)復刻紅韻仙草(L)買 1 送 1```|```無```|```~ 9/10```|```珍煮丹 指定分店```|
|**UberEats【特選餐廳】優惠** : ```萬波奶茶島嶼紅茶古早味酸梅冰買 1 送 1```|```無```|```~ 9/10```|```萬波 指定分店```|
|**UberEats【特選餐廳】優惠** : ```冬瓜鮮豆奶買 1 送 1```|```無```|```~ 9/10```|```武林茶 指定分店```|
|**UberEats【特選餐廳】優惠** : ```金蘋百香桑葚香檸格雷冰茶買 1 送 1```|```無```|```~ 9/10```|```康青龍 指定分店```|
|**UberEats【特選餐廳】優惠** : ```麥香燻雞起司磚壓+莊園美式(中杯)麥香燻雞起司磚壓+紅、綠茶(中冰大熱)芒果綠茶(大冰)西西里咖啡(中冰)買 1 送 1```|```無```|```~ 9/10```|```Louisa 路易莎```|
|**UberEats【特選餐廳】優惠** : ```輕烏龍買 1 送 1```|```無```|```~ 9/10```|```得正 指定分店```|
|**UberEats【特選餐廳】優惠** : ```甜杏凍烏龍蜜桃紅茶買 1 送 1```|```無```|```~ 9/10```|```春陽茶事 指定分店```|
...
|**foodpanda特選餐廳優惠碼** : ```全尺寸、全口味披薩買一送一```|```啃德基九省```|```~ 9/8```|```達美樂```|
...
|**foodpanda生鮮雜貨優惠碼** : ```滿 $319 享 79 折最高折 $75可用３次```|```買小七九省```|```~ 9/30```|```統一超商系列分店```|
