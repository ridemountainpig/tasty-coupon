...
|**訂閱會員優惠碼** : ```週三會員日 滿額 7折```|```無```|```4/3 限定```|```摩斯漢堡 指定分店```|
|**訂閱會員優惠碼** : ```週三會員日 滿額 7折```|```無```|```4/10 限定```|```星巴克 指定分店```|
|**訂閱會員優惠碼** : ```週三會員日 滿額 7折```|```無```|```4/17 限定```|```胖老爹 指定分店```|
|**訂閱會員優惠碼** : ```週三會員日 滿額 7折```|```無```|```4/24 限定```|```迷客夏 指定分店```|
...
|**訂閱會員優惠碼** : ```滿 $899 享 9 折最高折抵 $200可用１次```|```你多慧買家福```|```~ 4/30```|```家樂福```|
